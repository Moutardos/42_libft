...
gnl/count_lines.o
_OBJS_BONUS =ft_lstnew.o ft_lstdelone.o ft_lstclear.o ft_lstadd_front.o ft_lstadd_back.o\
ft_lstmap.o ft_lstiter.o ft_lstlast.o ft_lstsize.o
OBJS = $(patsubst %, $(ODIR)/%, $(_OBJS))
OBJS_BONUS = $(patsubst %, $(ODIR)/%, $(_OBJS_BONUS))
RM = rm -f
LIBFLAGS = -rc
